              ...
              <div class="table-responsive">
                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    $tampil = $conn->query("SELECT * FROM tb_pengajuan WHERE status='diterima'");
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body mx-3 mb-4">                  
                    ...
                    <input type="hidden" class="form-control " name="id_pengajuan" value="<?= $data_ubah['id_pengajuan']?>">
                      ...
                      <button type="submit" name="kembali" class="btn btn-secondary btn-user btn-block">Kembalikan</button>
                    </form>
                  </div>
                  <?php
                ...
                if (isset($_POST['ubah'])) {
                  ...
                  if ($ubah) {
                    ?>
                      ...
                      window.location.href="?page=pengajuan1";
                      </script>
                    <?php
                    }
                  } if (isset($_POST['kembali'])) {

                      $sql_kembali = $conn->query("UPDATE tb_pengajuan SET pengajuan = '$pengajuan', status = '$kembali' WHERE id_pengajuan = '$id_ubah'");
                        if ($sql_kembali) {
                          ?>
                      <script>
