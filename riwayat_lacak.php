                ...
                <div class="col-lg-7 my-2 pt-2 pl-3">
                  ...
                  if (isset($_POST['lacak'])) {
                    ...
                    if ($data['status'] == 'pending') {
                      ...
                      echo"<h4 class='mt-4'>Status Pengajuan Surat Pengantar Anda : ".strtoupper($data['status']); ".</h4>";
                    }
                    ...
                    if ($data['status'] == 'konfirmasi') {
                      ...
                      echo"<i class='fas fa-folder-open pr-3 pl-3 text-success' style='font-size: 13vh;'></i>";
                  ...
                  <?php if(isset($error)): ?>
                    <div class="alert alert-danger" role="alert"><h6>Nomor Registrasi tidak terdaftar / tidak sesuai. Mohon periksa kembali</h6></div>
                  <?php endif; ?>
                </div>
